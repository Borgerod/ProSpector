...
# def resetBrregTable(): #TEMP while testing
# 	try:
# 		brreg_table = fetchData(tablename = 'brreg_table')
# 	except:
# 		brreg_table=[]
# 	print(f'current length of brreg_table: {len(brreg_table)}')
# 	# time.sleep(0.5)
# 	if input("are you sure you want to reset brreg_table? (y/n)") == "y" or "Y" or "yes" or "Yes":
# 		print("	resetting brreg_table..")
# 		brreg = fetchData(tablename = "brreg_table")
# 		brreg_table = brreg[['org_num', 'navn']]
# 		replacetData(brreg_table, tablename = "brreg_table")
# 		print("	reset complete.")
# 		print(f'new length of brreg_table: {len(brreg_table)}')
