...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color cardColor = Color(0xFFF9FDFF);
  late Color thirdTextColor = Color(0xFF2E2F2F);
  late Color customColor2 = Color(0xFF18485C);
  late Color error = Color(0xFFFF6063);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryBackground = const Color(0xFF22282F);
  late Color secondaryBackground = const Color(0xFF353E49);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF95A1AC);

  late Color primaryBtnText = Color(0xFFFFFFFF);
  late Color lineColor = Color(0xFF22282F);
  late Color boarderColor = Color(0x1A000000);
  late Color handleColor = Color(0x80000000);
  late Color tertiaryGradient = Color(0xFF1E2227);
  late Color menuColor = Color(0xFF14181B);
  late Color customColor1 = Color(0xFF353E49);
  late Color darkmode = Color(0xFF15181C);
  late Color cardColor = Color(0xFF191E22);
  late Color thirdTextColor = Color(0xFFD6D8DA);
  late Color customColor2 = Color(0xFF18485C);
  late Color error = Color(0xFFB8484A);
}
