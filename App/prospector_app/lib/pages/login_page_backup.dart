...
// import 'package:prospector_app/components/update_widget.dart';
// // import 'package:prospector_app/components/update_widget_test.dart';
...
// import 'package:prospector_app/backend/api_requests/api_calls.dart';
// import 'package:prospector_app/pages/signup_page.dart';
...
//                                   builder: (context, snapshot) {
//                                     print(
//                                         "showMessage future == ${snapshot.data}");
//                                     return Container(
//                                         child: Column(
//                                       children: [
//                                         Text(
//                                           "Latest Version ${snapshot.data!['version']}",
//                                           style: TextStyle(
//                                             color: Colors.white,
//                                             fontSize: 20,
//                                           ),
...
//                                 // Container(
//                                 //   // child: Center(
//                                 //   child: getUpdateDialogueOrLoginForm(snapshot),
//                                 //   // ),
//                                 // );
//                               }),
//                         ),
...
//                         //                     Login.callback(email, pass,
//                         //                         isChecked, box1, context);
//                         //                   },
//                         //                 ),
//                         //               ),
//                         //             ),
...
//   getUpdateDialogueOrLoginForm(snapshot) {
...
//       future: loadJsonFromGithub(),
//       builder: (context, snapshot) {
//         print("showMessage future == ${snapshot.data}");
//         return Container(
//             child: Column(
//           children: [
//             Text(
...
//                     Navigator.pop(context);
//                     if (Platform.isMacOS) {
//                       downloadNewVersion(snapshot.data!["macos_file_name"]);
//                     }
//                     if (Platform.isWindows) {
//                       downloadNewVersion(snapshot.data!["windows_file_name"]);
//                     }
//                   },
//                   icon: const Icon(Icons.update),
//                   label: const Text("Update")),
